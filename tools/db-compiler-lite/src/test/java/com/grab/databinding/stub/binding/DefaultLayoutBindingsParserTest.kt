...
import com.grab.databinding.stub.binding.parser.DefaultLayoutBindingsParser
import com.grab.databinding.stub.binding.store.LayoutTypeStore
import com.grab.databinding.stub.binding.store.LocalModuleLayoutTypeStore
...
class DefaultLayoutBindingsParserTest : BaseBindingStubTest() {
                ...
                contents = """
                    <layout xmlns:android="http://schemas.android.com/apk/res/android">
                        ...
                        <data>
                            <variable
                                name="vm"
                                type="com.grab.databinding.stub.TestClass" />
                            <variable
                                name="vm_db"
                                type="Integer" />
                        </data>
    ...
    fun `assert bindables are parsed correctly`() {
        ...
        assertEquals("com.grab.databinding.stub.TestClass", vm.typeName.toString())
